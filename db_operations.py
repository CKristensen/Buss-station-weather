...
def create_data_mart():
	queries = ['CREATE SCHEMA IF NOT EXISTS datamart_star;',
				'CREATE SCHEMA IF NOT EXISTS frostentur;',
				...
				'''CREATE TABLE IF NOT EXISTS datamart_star.weatherstation_s (
					...
					latitude float,
					longitude float);''',
				'''CREATE TABLE IF NOT EXISTS datamart_star.closest_buss_weather_station (
					stop_name text,
